...
export default function EditProduk({currentUser}) {
  ...
  const formik = useFormik({
    initialValues: {
      idKategori: produk ? produk.id_kategori : "",
      idSubKategori: produk ? produk.id_sub_kategori : "",
      idBrand: produk ? produk.id_brand : "",
    ...
    onSubmit: async (data) => {
      ...
      services.editProduct(formData, id)
        .then((response)=>{
          Swal.fire({
            icon: 'success',
            title: 'Edit Berhasil',
  ...
  return (
    <div>
      ...
      <NavbarAndSidebar nama={currentUser.nama}>
        ...
        <h1 className="text-center m-5">Edit Produk</h1>
