...
export default function Brand({currentUser}) {
  ...
  const tambah = async () => {
    ...
    if (formValues) {
      ...
      formData.append('namaBrand', formValues[0]);
      formData.append('deskripsiBrand', formValues[1]);
      formData.append('logoBrand', formValues[2]);

      services.tambahBrand(formData)
        .then((response)=>{
          Swal.fire({
            icon: 'success',
          ...
          setPage(0);
          setCari("")
          services.dataBrand(page,itemPerPage,cari)
            .then((response)=>{
  ...
  return (
    <div>
      ...
      <NavbarAndSidebar nama={currentUser.nama}>
        ...
        <h1 className="text-center m-5">Brand</h1>
          ...
          <div className="table-responsive">
            <table className="table table-bordered">
              <thead>
                <tr>
                  <th scope="col">No</th>
                  <th scope="col">Gambar Brand</th>
                  <th scope="col">Nama Brand</th>
                  <th scope="col">Deskripsi Brand</th>
                ...
                { kategori ?
                  kategori.items.map((admin, index)=>
                    <tr key={index}>
                      ...
                      <td><img src={services.gambarBrand(admin.logo_brand)} className="img-fluid" /></td>
                      <td>{admin.nama_brand}</td>
                      <td>{admin.deskripsi_brand}</td>
                      <td>
